...
{
    public class PinConfigurationManager
    {
        ...
        public class HsmConfiguration
        {
            ...
            public string PinVerificationKeyPVV
            {
                get
                {
                    return HsmConfig["PinVerificationKeyPVV"];
                }
            }
            ...
            public string EncryptedPinLength
            {
                get
                {
                    return HsmConfig["EncryptedPinLength"];
                }
            }
